...
<div class="container">		
		<h1>Tambah produk</h1> 
		<form class="form-horizontal" action="<?php echo site_url()?>/dasboard/aksi_edit" method="POST" enctype="multipart/form-data">
			<div class="form-group">
				<label class="control-label col-sm-2" for="nama">Nama Produk:</label>
				<div class="col-sm-10">
					<input type="text" name="nama_produk" class="form-control" value="<?php echo $data->name; ?>">
					<input type="hidden" name="id" class="form-control" value="<?php echo $data->product_id ; ?>">
					<input type="hidden" name="foto_lama" class="form-control" value="<?php echo $data->image; ?>">
				</div>
			</div>
			<div class="form-group">
				<label class="control-label col-sm-2" for="alamat">Harga:</label>
				<div class="col-sm-10">
					<input type="number"  name="harga" class="form-control" id="alamat" value="<?php echo $data->price; ?>">
				</div>
			</div>		
			<div class="form-group">
				<label class="control-label col-sm-2" for="alamat">Deskripsi :</label>
				<div class="col-sm-10">
                    <textarea name="deskripsi" name="deskripsi" class="form-control" id="" cols="30" rows="10"><?php echo $data->description; ?></textarea>
				</div>
            </div>	
            <div class="form-group">
